return function(t, p, config)
    ...
    return {
        ...
        GitSignsAddLn = { bg = t.panel_bg },
        GitSignsChangeLn = { bg = t.panel_bg },
        GitSignsChangedeleteLn = { bg = t.panel_bg },
        GitSignsUntrackedLn = { bg = t.panel_bg },
        ...
        GitSignsAddPreview = { fg = t.added, bg = t.panel_bg },
        GitSignsDeletePreview = { fg = t.deleted, bg = t.panel_bg },
